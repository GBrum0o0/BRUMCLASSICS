    ...
    var body: some View {
        ScrollView {
            LazyVStack(alignment: .leading, spacing: 28) {
                ...
                NavigationLink { ClassicsEverywhereView() } label: { SettingsRow(icon: "gamecontroller", title: "CLASSICS in every everywhere", detail: "Suas ROMs da pasta Downloads · toque para jogar") }.accessibilityIdentifier("classics-everywhere-link")
