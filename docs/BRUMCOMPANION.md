...
Requisitos recomendados: BRUMCLASSICS OFICIAL 1.49.1 e BRUMCLASSICS MOVEL 0.13.1. Consulte também o [guia móvel completo](MOVEL.md).

## Preparação

1. Atualize o launcher em **Configurações → Sistema → Atualizações**.
2. Instale o APK 0.13.1 sobre a versão móvel existente, sem apagar os dados do aplicativo. Use **Perfil → Atualizações**; ao migrar de HTTP, refaça o pareamento pelo QR completo HTTPS.
