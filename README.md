...
<p align="center">
  <a href="https://github.com/GBrum0o0/BRUMCLASSICS/releases/tag/v1.60.1"><strong>Windows 1.60.1</strong></a> ·
...
| --- | ---: | --- |
| Windows | 1.60.1 | [Release do launcher](https://github.com/GBrum0o0/BRUMCLASSICS/releases/tag/v1.60.1) |
...
- **Launcher 1.60.1:** explorador de conexões refinado, detalhes em tela dedicada, validação visual por etapas e navegação Voltar corrigida.
...
1. Baixe o executável portátil da [release Windows 1.60.1](https://github.com/GBrum0o0/BRUMCLASSICS/releases/tag/v1.60.1).
