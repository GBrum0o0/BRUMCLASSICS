...
public final class LocalArtworkClient {
    ...
    private HttpURLConnection open(URL url) throws Exception {
        ...
        connection.setUseCaches(false); connection.setRequestProperty("Accept", "application/json,image/png,*/*"); connection.setRequestProperty("User-Agent", "BRUMCLASSICS-Android/0.19.0"); return connection;
    }
